...
const BAD_FRUIT_PROBABILITY = 0.1;
...
// ========================================================
function setup() {
    createCanvas(1555, 755);

    sword = new Blade(color("#ac1fe0")); // change sword color
    frameRate(200); //60 FPS
...
function draw() {
    background("#676d77"); //background color of map
...
// Send out new fruit
  if (frameCount % 10 === 0) {
		...
		if (noise(frameCount) > 0.6) { //decides how many times to send a fruit
